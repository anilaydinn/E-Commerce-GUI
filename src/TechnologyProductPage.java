...
public class TechnologyProductPage extends JFrame {
	 ...
	 * Create the frame.
	 */
	public TechnologyProductPage(String username) {
		...
		lblPC1.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				computer.setModel("N57");
				computer.setGraphicCard("RTX 2080Ti");
				computer.setOperatingSystem("Windows");
				computer.setPrice(11000);
				computer.setProcessor("İntel İ7 6700HQ");
				computer.setRam("16GB");
				ProductDetailsPage productDetailsPage = new ProductDetailsPage(computer);
				setVisible(false);
